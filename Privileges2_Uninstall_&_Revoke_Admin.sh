...
# latest change by SAP:
# 2025/10/29 

# latest change by me:
# 2026/01/16
# Added line 134: "/Library/Managed Preferences/corp.sap.privileges"* \
# Added lines 57-59 to remove the user from admin.
# Permalink to original: https://github.com/SAP/macOS-enterprise-privileges/blob/1fd0e493f63c9540f52949fe244cf5473c8e863a/application_management/Privileges2_Uninstall.sh
